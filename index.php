...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light custom" id="main-navigation" style="background: url('assets/nav.png')">
     ...
     <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
        ...
        <a class="nav-link underline" href="#">Domů <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
    ...
    <!-- END navbar -->
        ...
        <img id="main-image" src="assets/header.jpg">
        <br>
          <div class="container" align="center" id="headerimg">
            <br>
            <br>
            <br>
              <h1 id="headerimg-h1">Zaujali jsme Vás?</h1>
              <span id="headerimg-h2">Podívejte se na náš blog.</span>
            <br>
          </div>
          <br>
          <br>
          ...
          <div class="container" style="border:1px solid #000000; margin-top: 10px;">
